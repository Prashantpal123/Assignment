        ...
        <div className=' full-screen-black'>
            ...
            <div className='flex justify-center mx-2 ' >
                <div className='mt-20 md:mt-12'>
                    ...
                    <h1 className='text-[#f4f4f4] text-[28px] md:mt-4 leading-13 md:text-[60px] lg:text-[60px] font-extrabold md:leading- '>Welcome to <span className='text-[#fcbb38]'>Quize-Zone</span> </h1>
                </div>
            ...
            <div className=" px-4 mt-8 md:mt-8   flex items-center justify-center">
                <div className=" rounded-lg  shadow-lg max-w-md w-full">
                    <h2 className="text-2xl font-semibold text-center mb-4 text-[#f4f4f4] ">Quiz Settings</h2>
                    <form onSubmit={handleSubmit} className="space-y-4 mt-8 max-w-[400px]  bg-[#f4f4f4] p-2 rounded-2xl">
                        <div className='mx-3'>
